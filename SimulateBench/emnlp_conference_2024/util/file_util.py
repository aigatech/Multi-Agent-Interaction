...
def makedir_():
    raw_obj_path = "/home/location2/pycharm/GPTMan/db/template/homer/examples_and_requirements/anthropomorphize.json"
    ...
    raw_path = "/home/location2/pycharm/GPTMan/db/template/{person_name}/examples_and_requirements/"
    for person_name in [
        "homer_1985",
        "homer_2000",
        "homer_2010",
...
def copy_files(person_names: str, file_type: str) -> None:
    ...
    for person_name in person_names:
        source = os.path.join(
            "/home/location2/pycharm/GPTMan/db/benchmark",
            file_type,
            person_name,
            "profile_v1",
            "system_v1",
        ...
        target_path = os.path.join(
            "/home/location2/pycharm/GPTMan/db/benchmark_only_QA",
            file_type,
            person_name,
        )
...
if __name__ == "__main__":
    person_names = load_file_list(
        "/home/location2/pycharm/GPTMan/db/benchmark/basic_information"
    )
